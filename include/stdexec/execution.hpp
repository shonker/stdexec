...
namespace stdexec {
  ...
  template <class _Ty, class _Tag = set_value_t>
    using __sender_domain_t =
      __domain_of_or_t<_Ty, get_completion_scheduler_t<_Tag>>;
  ...
  namespace __then {
    ...
    struct then_t {
      ...
      sender auto operator()(_Sender&& __sndr, _Fun __fun) const
        ...
        auto __domain = __get_domain_with_fallback_t{}(__sndr, get_completion_scheduler<set_value_t>);
  ...
  namespace __upon_error {
    ...
    struct upon_error_t {
      ...
      sender auto operator()(_Sender&& __sndr, _Fun __fun) const
        ...
        auto __domain = __get_domain_with_fallback_t{}(__sndr, get_completion_scheduler<set_error_t>);
  ...
  namespace __upon_stopped {
    ...
    struct upon_stopped_t {
      ...
      sender auto operator()(_Sender&& __sndr, _Fun __fun) const
        ...
        auto __domain = __get_domain_with_fallback_t{}(__sndr, get_completion_scheduler<set_stopped_t>);
